// English-only ISO 3166-1 alpha-2 -> country name lookup.
//
// The web app uses `Intl.DisplayNames([locale], {type:'region'})`, which has no
// direct Flutter/Dart equivalent bundled with the SDK. As a pragmatic parity
// simplification, country names are shown in English across all 5 app locales
// (everything else in the UI is fully localized) rather than shipping a
// hand-maintained 250-country translation table for nl/de/fr/es.
...
/// XO is a synthetic pseudo-country code for open-ocean/unattributed strikes.
String countryName(String code) {
  if (code == 'XO') return 'Open Ocean';
  return kCountryNames[code.toUpperCase()] ?? code;
}
