...
export const metadata: Metadata = {
  title: 'Strike Archive',
  description:
    'Historical lightning strike archive with all-time highs, daily records, and filterable history for every country.',
  alternates: { canonical: 'https://lightning-counter.fly.dev/stats' },
  openGraph: {
    title: 'Lightning Strike Archive | Lightning Stats',
