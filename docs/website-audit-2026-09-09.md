...
The remaining work covers restart durability, daily date attribution, framework maintenance, and archive query isolation. Existing user changes in `app/globals.css` and `tsconfig.tsbuildinfo` were left untouched.
